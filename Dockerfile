...
# Make sure the dependencies are met
RUN eval ${APT_INSTALL_PRE} curl tigervnc-standalone-server tigervnc-common tigervnc-tools fluxbox eterm xterm git net-tools python3 python3-numpy ca-certificates scrot pulseaudio-utils ${APT_INSTALL_POST}
